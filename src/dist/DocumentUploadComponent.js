...
var DocumentUploadComponent = function (_Component) {
  ...
  _createClass(DocumentUploadComponent, [{
    ...
    value: function componentDidMount() {
      ...
      //     this.setState({documentSubType:"LOAD"})
      //     this.setState({identifier:"c6cf8ad2-fb43-4e75-b3d8-e6b7aaeef8f5"})
      // }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'content' },
          _react2.default.createElement(_receivedDocuments2.default, { closeModal: closeModal, recievedDocumentsData: receivedDocumentsResponse, documentSubType: this.state.documentSubType, identifier: this.state.identifier })
        )
      );
    }
  }]);
