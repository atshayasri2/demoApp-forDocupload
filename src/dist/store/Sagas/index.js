...
function uploadDocument(action) {
    var request_payload, request_uri, response, shipmentId;
    return _regeneratorRuntime2.default.wrap(function uploadDocument$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                ...
                case 8:
                    shipmentId = JSON.parse(action.payload.uploadData.get("metadata")).identifier;
                    _context2.next = 11;
                    return (0, _effects.put)({ type: _items.Types.GET_RECEIVED_DOCUMENETS, payload: { shipmentId: shipmentId } });
